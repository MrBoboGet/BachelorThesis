...
\Huge{Graf färgning med modular decomposition}\\\\ %Fyll i titel
...
being NP-Hard means that optimal solutions are often too computationally expensive to use in practice, and in turn that many
instances require the use of heuristics. This thesis examines a
heuristic based on the modular decomposition of a graph, a way to split the graph
into well-structured subgraphs called modules, where some parts can be colored optimally in linear time,
...
\end{center}
\textit{
Graf färgning är ett av de vanligaste och mest efterforskade problemen i datavetenskapen.
Det har många användningsområden, till exempel för schemaläggning och
kompilatoroptimeringar, men eftersom problemet är 
NP-fullständigt så är optimala lösningar oftast för långsamma för att använda i praktiken. Detta innebär att 
många applikationer behöver använda sig av heuristiker istället. Den här uppsatsen undersöker en heuristik
baserad på en  grafs "modular decomposition". Det är ett sätt att dela upp en graf i subgrafer ,"modules", där vissa modules har en speciell
struktur som låter dem färgas optimalt i linjär tid, medan andra kräver heuristiker. Denna metod gav bättre
färgningar i kombination med en av de testade heuristikerna, och ingen skillnad för de andra.
}
\end{NewFont}
...
every vertex a unique color. Finding an optimal coloring however, i.e. a proper 
...
associated with a strong module containing a single vertex. This means that
...
\newcommand{\lfigbase}{0.5\textwidth}

\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Graph1.pdf}
...
\begin{figure}[H]
    \includegraphics[width=\figbase]{Graph2.pdf}
...
\begin{figure}[H]
    \includegraphics[width=\figbase]{Graph3.pdf}
...
\begin{figure}[H]
    \includegraphics[width=\figbase]{Graph4.pdf}
...
\begin{figure}[h!]
    \includegraphics[width=\figbase]{Graph5.pdf}
...
color from $used$ this way is at most  $|deg(v)|+1$ steps. This part correspond to
lines 5-8.
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Greedy1.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Greedy2.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Greedy3.pdf}
...
Vertices are added one at a time when creating a part in the partition.  Doing
the partition "largest first" means that we want to add the vertices with the
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\lfigbase]{RLF1.pdf}
    \caption{Initial graph}
    \label{fig:rlf1}
\end{figure}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\lfigbase]{RLF2.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\lfigbase]{RLF3.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\lfigbase]{RLF4.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\lfigbase]{RLF5.pdf}
...
\begin{definition}[Quotient graph]
    The quotient graph $Q$ for a graph $G = (V,E)$ over a partition 
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies1.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies2.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies3.pdf}
    \caption{Modular decomposition of graph}
    \label{fig:strat3}
\end{figure}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies3b.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies4c.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies5.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies6.pdf}
...
and end with a proper coloring, so are we using the set of colors from the module
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies9.pdf}
...
\begin{figure}[H]
    \centerfloat
    \includegraphics[width=\figbase]{Strategies10.pdf}
...
First an ordinary binary tree is randomly generated with a specified number of
...
and the probability for edges within a module, and finally the number and size of
the prime modules. 
...
The script colors the graph described in the file with a every combination of 
...
groups in turn divide the result into separate groups depending on the number of
