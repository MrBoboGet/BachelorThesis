...
potential decrease in colors most likely doesn't compensate for the increased
...
by both series percent and the amount of graph modules, as well as the graph size.
...
the amount of edges/vertices could theoretically see a speedup when applied 
...
heuristics doesn't see the same benefit, and instead take longer time to execute. 
The more vertices and the more edges a graph has the larger this difference would be 
, which would explain why the difference is higher for 70\% series percent, and why 
